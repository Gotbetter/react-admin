    ...
    const login = async () => {
        try {
            ...
            if (error.response.status === 403) {
                alert("관리자만 이용 가능합니다.");
            } else if (authId === "" & password === "") { // 아이디, 비밀번호 모두 공백인 경우
    ...
    return (
        <Layout>
            <WhiteBox>
                ...
                <TextInput type="text" placeholder="아이디" onChange={(e) => setAuthId(e.target.value)}/>
                <TextInput type="text" placeholder="비밀번호" onChange={(e) => setPassword(e.target.value)}/>
