...
import { createPlanDislike, fetchNotDislikes } from "../../../../api/plan";

export default function AddPlanDislikeModal({
  handleClickModal,
  planId,
  queryKey,
}) {
  ...
  const fetchNotDislikeUsersQuery = useQuery(
    ["canClickDislikeUsers"],
    () => fetchNotDislikes(planId),
    {
      retry: 1,
      onError: handleError,
      onSuccess: async (data) => {
        console.log(
          "[NotDislikeUserList]: fetching not dislike user info list"
        );
